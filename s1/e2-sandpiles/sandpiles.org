...
# show the paper
It was called _Self Organized Criticality: An Explanation of 1/f Noise_,
and appeared in the July 1987 issue of Physical Review Letters.
...
gpw_char =: verb define
  ...
  select. {. sysdata
    case. '@' do. render img =: ? 32 32 $ 3        NB. @ = all 2
    case. '#' do. render img =: ? 32 32 $ 3        NB. # = all 3
    case. '$' do. render img =: ? 32 32 $ 4        NB. $ = all 4
